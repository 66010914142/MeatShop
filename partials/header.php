    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarsExample">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <?php else: ?>
                    <a class="btn btn-outline-light" href="<?= base_url('front/login.php') ?>">เข้าสู่ระบบ</a>
                    <a class="btn btn-warning fw-bold" href="<?= base_url('front/register.php') ?>">สมัครสมาชิก</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
