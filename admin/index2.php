<?php
    ...
    // --- [ส่วนที่แก้ไข] เปลี่ยนเป็นดึงข้อมูลสินค้าขายดีจากตาราง order_Details ---
    $sql_chart = "SELECT p.P_name, SUM(d.quantity) as total_qty 
            ...
            <div class="row mb-4">
                ...
                <div class="col-lg-4">
                    <div class="card card-custom h-100 text-center p-4">
                        ...
                        <div class="mt-3 small text-muted">คำนวณจากจำนวนสินค้าที่ขายได้จริง</div>
                    </div>
                </div>
            </div>
...
<script>
    // 1. Bar Chart (แก้ไขข้อมูลเป็นสินค้าขายดี)
    ...
    // 2. Doughnut Chart (แก้ไขข้อมูลเป็นสินค้าขายดี)
