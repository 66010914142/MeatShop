<?php
    ...
    // --- 2. เปลี่ยนเป็นดึงข้อมูลสำหรับกราฟสินค้าขายดี (Top 5 Best Selling) ---
    // ดึงชื่อสินค้าจากตาราง products และผลรวมจำนวนที่ขายได้จากตาราง order_Details
            ...
            <div class="row mb-4">
                <div class="col-lg-8">
                    <div class="card card-custom h-100">
                        <div class="card-header bg-white py-3"><h6 class="fw-bold mb-0">5 อันดับสินค้าขายดีที่สุด (จำนวนชิ้น)</h6></div>
                        <div class="card-body">
                ...
                <div class="col-lg-4">
                    <div class="card card-custom h-100 text-center p-4">
                        <h6 class="fw-bold mb-3">สัดส่วนสินค้าขายดี</h6>
                        <canvas id="statusDoughnut"></canvas>
                        <div class="mt-3 small text-muted">วิเคราะห์จากจำนวนสินค้าที่ถูกสั่งซื้อ</div>
                    </div>
                </div>
            </div>
...
<script>
    // 1. กราฟสินค้าขายดี (เปลี่ยนจาก Bar Status เป็น Top Products)
